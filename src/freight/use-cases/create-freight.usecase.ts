...
export class CreateFreightUseCase {
   ...
   */
  async execute(dto: CreateFreightDto, clientId: string) {
    const freight = await this.freightsRepository.create(dto, clientId);
    console.log(clientId, 'clientId in create freight usecase');
